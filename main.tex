...
Information Technology (IT) has been gaining ground in companies and agencies, it has come to be seen as an asset for being an area of intelligence, identifying new opportunities and problems as well. If used correctly, IT can promote important gains in the place where it is applied, and prevent a setback from increasing and becoming worse.

In this context, the Intelligence Center panel should be used to monitor repetitive demands, trying to prevent these demands from multiplying too quickly, consuming resources from the Federal Justice.

\noindent\textbf{Keywords}: BI. Data. Information.
\end{otherlanguage*}
\end{resumo}
